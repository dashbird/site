---
title: Python Activity Tracking & Error Monitoring for Lambda
description: Monitor, profile and troubleshoot your Lambda functions. Set up in 96 seconds, no code changes!
...
<div class="bg-white">
  ...
  <div class="row pt-7">
    ...
    <div class="col-12 col-md-6 landing-text">
      <div class="col-12 col-xs-10 col-sm-12 col-lg-10 landing-text-inner sf-ui-text">
        <h2 class="landing-titles ">Optimize AWS Lambda functions for speed and cost</h2>
  ...
  <div class="row pt-7">
    ...
    <div class="col-12 col-md-6 landing-text">
      <div class="col-12 col-xs-10 col-sm-12 col-lg-10 landing-text-inner sf-ui-text">
        <h2 class="landing-titles ">Stack traces and Slack alerts</h2>
