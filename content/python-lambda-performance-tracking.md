...
<section class="container slogan">
  <div class="row justify-content-md-end">
    <div class="col-lg-6">
      <h1 class="text-center text-md-left">Python AWS Lambda Performance Tracking</h1>
      <h2 class="mt-4 text-center text-md-left lato">Monitor AWS Lambda functions in real time.</h2>
      <h2 class="lato text-center text-md-left">Performance- and cost tracking, error handling.</h2>
      <div class="pt-5 pr-5">
...
<section class="container-fluid dark-bg mt-5">
  ...
  <div class="row">
    <div class="col text-center mt-5">
      <span class="h4 text-uppercase">Easy setup</span>
    </div>
  </div>
        ...
        <div class='col-12 col-md mt-1'>
          <div class='card h-200'>
            <div class='card-body mt-3'>
              ...
              <hr>
              <span class='h4 lato'>Lambda tracking & alerts</span>
    ...
    <div class="col-10 mt-4 mx-auto">
      <div class='row'>
        <div class='col text-center pb-3 pt-5'>
          <h2>Dashboard for your AWS Lambda functions</h2>
        </div>
      </div>
      <div class="row">
  ...
  <div class="row justify-content-md-center align-items-center">
    <div class="col-10 p-3 mt-5 mx-auto">
      <div class='row'>
        <div class='col text-center pb-3 pt-5'>
          <h2>Function profiling and troubleshooting</h2>
        </div>
      </div>
      <div class="row">
