...
<section class="container slogan">
  <div class="row justify-content-md-end">
    <div class="col-lg-6">
      <h1 class="text-center text-md-left">Activity & Cost Tracking for Java AWS Lambda</h1>
    ...
    <div class="col-10 bg-white p-3 mt-5 mb-4 mx-auto">
      <div class="row">
        ...
        <div class="col-md-6 text-center text-md-left pt-4">
          <h3>Performance and cost tracking</h3>
          <p class="lato h4 lh-2">All the data is extracted from CloudWatch logs, meaning your functions wont slow down. Get metric statistics for memory usage, durations, cost and invocation volumes in every application layer.</p>
    ...
    <div class="col-10 bg-white p-3 mt-5 mb-4 mx-auto">
      <div class="row">
        <div class="col-md-7 text-center text-md-left pt-4">
          <h3>Detailed alerts via Slack.</h3>
          <p class="lato h4 lh-2">Each error includes detailed stack-traces, logs and is linked to similar errors for easier debugging efforts.</p>
