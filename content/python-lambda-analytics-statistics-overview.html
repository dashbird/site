---
title: Statistical Overview & Actionable Metrics For AWS Lambda in Python
description: Lambda latency, metrics and alerting. Improve Serverless cost and performance.
...
<div class="bg-white">
  ...
  <div class="row pt-7">
    ...
    <div class="col-12 col-md-6 landing-text">
      <div class="col-12 col-xs-10 col-sm-12 col-lg-10 landing-text-inner sf-ui-text">
        <h2 class="landing-titles ">Track resource usage and cost</h2>
  ...
  <div class="row pt-7">
    ...
    <div class="col-12 col-md-6 landing-text">
      <div class="col-12 col-xs-10 col-sm-12 col-lg-10 landing-text-inner sf-ui-text">
        <h2 class="landing-titles ">Get alerted of all failures</h2>
