---
title: Troubleshooting Aws Lambda 
		...
		<div class="row pt-7">
			...
			<div class="col-12 col-md-6 landing-text">
				<div class="col-12 col-xs-10 col-sm-12 col-lg-10 landing-text-inner sf-ui-text">
					<h2 class="landing-titles ">Monitor your application</h2>
					<p>With Dashbird you'll get an instant overview of your application allowing you to troubleshoot your AWS Lambda application with a great deal of ease.</p>
				</div>
			</div>
		</div>
		<div class="row pt-7">
			...
			<div class="col-12 col-md-6 landing-text">
				<div class="col-12 col-xs-10 col-sm-12 col-lg-10 landing-text-inner sf-ui-text">
					<h2 class="landing-titles ">Get error alerts</h2>
					<p>You can rest easy at nights knowing that we keep a close eye on your Lambda functions and if you happen to get an error you'll be immediately notified through your favorite channel.</p>
				</div>
			</div>
		</div>
		<div class="row pt-7">
