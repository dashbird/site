---
title: Python Lambda Monitoring Based on CloudWatch Logs - Dashbird
    ...
    <div class="col-10 bg-white p-3 mt-5 mb-4 mx-auto">
      <div class="row">
        ...
        <div class="col-md-6 text-center text-md-left pt-4">
          <h3>Resource and cost tracking</h3>
          <p class="lato h4 lh-2">Get metrics for invocation volumes, memory utilisation, duration and cost. Easily set up real-time dashboards for your Serverless projects.</p>
    ...
    <div class="col-10 bg-white p-3 mt-5 mb-4 mx-auto">
      <div class="row">
        <div class="col-md-7 text-center text-md-left pt-4">
          <h3>Error alerting and troubleshooting</h3>
          <p class="lato h4 lh-2">Dashbird detects errors in your Lambda functions and alerts you via Slack or email. Each error includes detailed stack-traces, logs and is linked to similar errors for easier debugging efforts.</p>
